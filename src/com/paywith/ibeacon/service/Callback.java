...
public class Callback {
	...
	public Callback(String intentPackageName) {
		if (intentPackageName != null) {
			intent = new Intent();
            intent.setComponent(new ComponentName(intentPackageName, "com.paywith.ibeacon.IBeaconIntentProcessor"));
        }
	}
	...
	public boolean call(Context context, String dataName, Parcelable data) {
		if (intent != null && 1 == 0) { // disabling callbacks - our app works differently now
			Log.i(TAG, "attempting callback via intent: "+intent.getComponent());
