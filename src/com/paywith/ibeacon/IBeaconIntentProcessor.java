...
import com.paywith.ibeacon.service.IBeaconData;
import com.paywith.ibeacon.service.MonitoringData;
import com.paywith.ibeacon.service.RangingData;
...
public class IBeaconIntentProcessor extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (rangingData != null) {
            ...
            if (notifier != null && iBeacons.size() > 0 && rangingData != null) {
