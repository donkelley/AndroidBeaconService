...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_BEACONSTORE_TABLE = "CREATE TABLE " + TABLE_BEACONSTORE + "("
                + KEY_ID + " INTEGER PRIMARY KEY," + KEY_UUID + " TEXT,"
                + KEY_MAJOR + " INT,"
                + KEY_MINOR + " INT" + ")";
 ...
 // Adding new beacon
    ...
    public BeaconStore getBeacon(int id) {
        ...
        Cursor cursor = db.query(TABLE_BEACONSTORE, new String[] { KEY_ID,
        		KEY_UUID, KEY_MAJOR, KEY_MINOR }, KEY_ID + "=?",
    ...
    /*public int updateBeacon(BeaconStore beacon) {
        ...
        values.put(KEY_PH_NO, beacon.getPhoneNumber());
    ...
    public void deleteContact(BeaconStore contact) {
